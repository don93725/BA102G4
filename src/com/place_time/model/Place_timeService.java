...
public class Place_timeService {
		...
		public Place_timeVO addPlace_Time(String pt_no,String p_no, String opc_acc, java.sql.Date rp_date,
				Integer rp_time,java.sql.Date op_date,String pbu_price,String pau_price,java.sql.Date pbu_date,java.sql.Date pau_date) {
		...
		public Place_timeVO updatePlace(String pt_no,String p_no, String opc_acc, java.sql.Date rp_date,
				Integer rp_time,java.sql.Date op_date,String pbu_price,String pau_price,java.sql.Date pbu_date,java.sql.Date pau_date) {
		...
		public void deletePlace(String pt_no) {
			
			dao.delete(pt_no);
		}

		public Place_timeVO getOnePlace(String pt_no) {
