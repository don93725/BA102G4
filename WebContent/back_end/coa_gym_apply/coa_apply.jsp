					...
					<table id="sample-table-1" class="table table-striped table-hover" style="text-align:center;">
						<thead class="aaa">
							<tr>
								...
								<th class="center" style="vertical-align:middle;">性別</th>
								<th class="center" style="vertical-align:middle;">身分證字號</th>
						...
						<tbody> 
							...
							<c:forEach var="coachesVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
								<tr class="center" style="vertical-align:middle;">
									<td class="center" style="vertical-align:middle;"><img src="<%=request.getContextPath()%>/tools/DBGifReader?coa_acc=${coachesVO.coa_acc}"
											style="width: 100px; height: 100px;"></td>
									<td class="center" style="vertical-align:middle;">${coachesVO.coa_acc}</td>
									<td class="center" style="vertical-align:middle;">${coachesVO.coa_name}</td>
									<td class="center" style="vertical-align:middle;">${coachesVO.coa_sex == 1 ?'男':'女'}</td>
									<td class="center" style="vertical-align:middle;">${coachesVO.coa_mail}</td>
<%-- 									<td class="center">${coachesVO.coa_into}</td> --%>
									<td class="center" style="vertical-align:middle;">${coachesVO.coa_sta == 0 ?'未審核':''}</td>
