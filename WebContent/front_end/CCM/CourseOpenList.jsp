...
<%
	...
	ArrayList<Course_timeVO> cpList = (ArrayList) course_timeSvc.getAllOpen(((MembersVO) session.getAttribute("user")).getMem_acc());
						...
						<tbody>
							<c:forEach var="course_timeVO" items="${cpList}">
								...
								<tr>
									...
									<td style="vertical-align:middle;" align="center;"><span class="changeCrs_name<%=count%>">${course_timeVO.courseVO.crs_name}</span></td>
									<td style="vertical-align:middle;" align="center;"><span class="changeCategory<%=count%>">${course_timeVO.courseVO.categoryChange}</span></td>
									<td style="vertical-align:middle;" align="center;"><span class="changeCrs_date_time<%=count%>">${course_timeVO.crs_date}<br>${course_timeVO.crs_timeShow}</span></td>
									<td style="vertical-align:middle;" align="center;"><span class="changePrice<%=count%>">$${course_timeVO.price}</span></td>
									<td style="vertical-align:middle;" align="center;"><span class="changeP_name<%=count%>">${course_timeVO.placeVO.p_name}</span></td>
									<!-- 故意擺兩個 -->
									<td style="vertical-align:middle;" align="center;"><a class="accordion-toggle" data-toggle="collapse"
