	...
	<form action="<%=request.getContextPath()%>/CCM/CourseManager.do" type="post">
		...
		<span>
			...
			<c:forEach var="course_pictureVO" items="${cpicList}">
				<img src="${course_pictureVO.crs_base}" width="15%" style="margin: 1em;"> 
			</c:forEach>
		<br><br>
        ...
        <span>
			<h4>
			開課人數　　　<input type="number" name="class_num" minlength="1" maxlength="2" required="required" style="width:85%;">
			</h4>
		</span>
		<span>
			<h4>
			人數上限　　　<input type="number" name="limit" minlength="1" maxlength="2" required="required" style="width:85%;">
			</h4>
		</span>
		<span>
			<h4>
			價錢　　　　　<input type="number" name="price" minlength="1" maxlength="6" required="required" style="width:85%;">
			</h4>
		</span>
		<span>
			<span id="place">
