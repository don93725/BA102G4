    ...
    <div class="container">
        ...
        <br>
            ...
            <div class="col-lg-12">
                ...
                <!--table開始-->
                <div class="col-lg-12 t-content">
                    <a href="#">
                    <div class="col-lg-12 well">
                    
                        
                        <div class="col-xs-12 col-sm-4">
                            <img src="https://api.fnkr.net/testimg/400x200/00CED1/FFF/?text=img+placeholder" class="img-responsive">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum id ullam reiciendis aut ab beatae modi, distinctio, accusamus mollitia explicabo necessitatibus odit delectus. A tempora, eius quis et quisquam aspernatur.
                                </div>
                            </div>
                            </div>
                    </div>
