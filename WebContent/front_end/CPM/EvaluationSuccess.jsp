...
<body>
	<form style="margin:2em;position: absolute;left: 15%;top:3%;" method="post">
		<img src="<%=request.getContextPath()%>/front_end/SCM/images/666.jpg" witdh="130" height="130"><font size="50px" style="font-weight:bold;position: relative;top: 35px;">評價成功</font><br>
		...
		<span style="position: relative;top: 3px;"><font size="4px" style="font-weight:bold;">評價內容:</font> <font size="3px" style="font-weight:bold;">${course_listVO.feedback}</font></span><br>
