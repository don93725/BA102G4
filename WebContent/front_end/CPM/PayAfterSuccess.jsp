...
<body>
	<form style="margin:2em;position: absolute;left: 15%;top:3%;" method="post">
		...
		<span style="position: relative;top: 3px;"><font size="4px" style="font-weight:bold;">付款金額 :</font> <font size="3px" style="font-weight:bold;">$${place_timeVO.pau_price}</font></span><br>
