			...
			<div class="col-lg-12">
				...
				<div class="tabbable">
					...
					<ul class="nav nav-tabs" id="myTab">
						...
						<!-- 課程管理 -->
						<li  id="manager">
							<a href="<%=request.getContextPath()%>/CPM/CoachesPlaceManager.do?action=courseList" id="dropdown1"><i
								class="green glyphicon glyphicon-pencil" style="font-size: 16px"></i>
								<font style='font-size: 16px; font-weight: bold;'> 選課列表 </font></a>
						</li>

						<!-- 課程紀錄 -->
						<li class="" id="record"><a href="<%=request.getContextPath()%>/CPM/CoachesPlaceManager.do?action=courseOpen" id="dropdown2"> <i
						...
						<!-- 課程課程報表紀錄 -->
						<li id="report"><a href="<%=request.getContextPath()%>/CPM/CoachesPlaceManager.do?action=courseRecord"><i
